...
;jQuery(function(a){function b(){var b=Cookies.get(j),c={v:a("input[name=visibility]:first").val(),s:!1,e:a("#expire").val(),f:"text"};if(b){var d=b.split("|");4===d.length&&(c.v=d[0],c.s="true"===d[1],c.e=d[2],c.f=d[3])}return c}function c(){var a=[k.v,k.s?"true":"false",k.e,k.f].join("|");Cookies.set(j,a,{expires:365,path:"/"})}function d(){a("#selfdestruct").prop("disabled","private"===k.v),a(".statusicons .status-expire").toggleClass("disabled","never"===k.e),a(".statusicons .status-selfdestruct").toggleClass("disabled",!k.s||"private"===k.v),a(".statusicons .status-visibility i").addClass("hidden").filter(".visibility-"+k.v).removeClass("hidden")}function e(){l.style.visibility="visible",m.style.visibility="visible"}function f(){l.style.visibility="hidden",m.style.visibility="hidden"}function g(a){a.dataTransfer.dropEffect="copy",a.preventDefault()}function h(a){a.preventDefault(),f()}function i(b,c){var d=c>=100;a(b).find(".state").text(c+"%"),a(b).find(".progress-bar").css("width",c+"%").attr("aria-valuenow",c).toggleClass("active",!d).toggleClass("progress-bar-info",!d).toggleClass("progress-bar-success",d)}a("body").on("click","a.postlink",function(){var b=a(this),c=b.attr("href").split("?"),d=c[0],e=c[1]||"",f=a("<form>").attr("action",d).attr("method","post"),g=a("html").data("csrf");if(a("body").append(f),""!==e){e=e.split("&");for(var h in e){var i=e[h].split("="),j=i[0],k=decodeURIComponent(i[1]);a("<input>").attr("type","hidden").attr("name",j).attr("value",k).appendTo(f)}}return g.length>0&&a("<input>").attr("type","hidden").attr("name","csrftoken").attr("value",g).appendTo(f),f.submit(),!1});var j="settings",k=b();if(a("#expire").val(k.e).on("change",function(){k.e=a(this).val(),c(),d()}),a("select[name=filetype]").val(k.f).on("change",function(){k.f=a(this).val(),c()}),a("#selfdestruct").prop("checked",k.s).on("change",function(){k.s=a(this).prop("checked"),c(),d()}),a('input[name=visibility][value="'+k.v+'"]').prop("checked",!0),a("body").on("change","input[name=visibility]",function(){k.v=a(this).val(),c(),d()}),d(),a(".opttoggle").on("click",function(){var b=a(".ext-options");b.slideToggle("fast"),a(this).toggleClass("active")}),a("body").on("click",".remover",function(){var b=a(this).closest("li");b.is(".finished")&&b.slideUp("fast",function(){b.remove()})}),a("body").is(".index")){var l=a(".drop-overlay")[0],m=a(".drop-help")[0];window.addEventListener("dragenter",e),l.addEventListener("dragenter",g),l.addEventListener("dragover",g),l.addEventListener("dragleave",f),l.addEventListener("drop",h),html5upload.initialize({maxSimultaneousUploads:3,uploadUrl:"/upload",dropContainer:l,inputField:a(".btn-file input")[0],key:"file",data:function(){return{expire:a("#expire").val()||"never",selfdestruct:a("#selfdestruct").prop("checked")?1:0,visibility:a("input[name=visibility]:checked").val()||"public",csrftoken:a("html").data("csrf")}},onFileAdded:function(b){var c=a(a("#upload-item").html());c.find(".name span").text(b.fileName),a("#uploads").append(c),b.on({onCompleted:function(d){try{d=JSON.parse(d)}catch(e){return}i(c,100),c.removeClass("uploading").addClass("finished"),"ok"===d.status?c.find(".name span").after(a("<a>").text(b.fileName).attr("href",d.uri).attr("target","_blank")).remove():(c.find(".progress-bar").removeClass("progress-bar-success").removeClass("progress-bar-info").addClass("progress-bar-danger"),c.find(".name span").addClass("text-danger"))},onProgress:function(a,b,d){i(c,parseInt(a,10))}})}})}jQuery.timeago.settings.allowFuture=!0,jQuery("time.rel").timeago()});